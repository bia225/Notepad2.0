...
public class Notepad extends JFrame {
   ...
   JTextArea area = new JTextArea(0,0);
    ...
    JMenuItem br = new JMenuItem("Red");

	JMenuItem bge = new JMenuItem("Green");

	JMenu fg = new JMenu("Foreground Color");

	JMenuItem fb = new JMenuItem("Blue");

	JMenuItem fr = new JMenuItem("Red");

	JMenuItem fge = new JMenuItem("Green");
    ...
    public Notepad()
    {
        ...
        FONT.setAccelerator(KeyStroke.getKeyStroke(KeyEvent.VK_L, ActionEvent.CTRL_MASK));
        ...
        //FINDS A WORD IN THE EDITOR
        FINDNEXTEDIT.setAccelerator(KeyStroke.getKeyStroke(KeyEvent.VK_F, ActionEvent.CTRL_MASK));
        ...
        fge.addActionListener( new ActionListener()
        {
            public void actionPerformed(ActionEvent e) 
            {
                if (e.getSource() == fge) {
        ...
        GOTOEDIT.setAccelerator(KeyStroke.getKeyStroke(KeyEvent.VK_G, ActionEvent.CTRL_MASK));
        ...
        ABOUT.addActionListener( new ActionListener()
        {
            public void actionPerformed(ActionEvent e)
            {
                ...
                String message = "Notepad Project done by the following:\n"+
                                     "Mohammad Berjawi 12140462 12\n"+
                                     "Mohammad Bourji 12122030\n"+
                                     "Rabih Kadi 12140268\n"+
                                     "Raed Nasreddine 12140073\n"+
                                     "CSI 250 Section A\n"+
                                     "AUST";
